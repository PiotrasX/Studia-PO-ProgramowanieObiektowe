...
public class Cuboid
{
    ...
    public double field(double a, double b, double c) { return 2*a*b+2*a*c+2*b*c; } // Pole powierzchni
    public double volume(double a, double b, double c) { return a*b*c; } // Objętość
