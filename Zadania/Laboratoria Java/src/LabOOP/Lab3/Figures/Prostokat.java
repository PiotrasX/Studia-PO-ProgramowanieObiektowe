...
public class Prostokat extends Figura implements IFigury
{
	...
	public void setSzer(double szer) { this.szer = szer; }

	public String opis() { return "Prostokat ma szerokość " + szer + " i wysokość " + wys; }
	...
	@Override
	public double getPowierzchnia() { return szer*wys; }
}
