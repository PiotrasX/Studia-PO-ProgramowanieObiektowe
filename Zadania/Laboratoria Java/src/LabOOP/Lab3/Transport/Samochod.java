...
public class Samochod extends SrodekTransportu implements Jedzie
{
    ...
    public int getKonie() { return konie; }
    public void setKonie(int konie) { this.konie = konie; }
    ...
    @Override
    public String jedz() { return " rusza z miejsca."; }
    @Override
    public String stoj() { return " zatrzymuje się."; }
    @Override
    String sposobPrzemieszczania() { return " jest lądowym środkiem transportu."; }
}
