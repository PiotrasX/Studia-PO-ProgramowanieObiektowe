package Lab6.ZadaniaException.Zad2;

// Zad. 2 Utwórz metodę wprowadzInt wraz z obsługą wyjątków tak aby np.: nie można było wprowadzić błędnej postaci
//        liczby tj. „1w2”. Utwórz metody wprowadzania innych typów danych np.: char, long, short, float, double,
//        String wraz z odpowiednią obsługą wyjątków. Do wprowadzania danych z konsoli użyj klasy Scanner.
