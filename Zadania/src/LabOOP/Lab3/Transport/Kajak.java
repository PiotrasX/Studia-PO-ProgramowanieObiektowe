...
public class Kajak extends SrodekTransportu implements Plywa
{
    ...
    @Override
    public String plyn() { return " zaczyna płynąć."; }
    @Override
    public String stoj() { return " dopływa do brzegu."; }
    @Override
    String sposobPrzemieszczania() { return " jest pływającym środkiem transportu."; }
}
