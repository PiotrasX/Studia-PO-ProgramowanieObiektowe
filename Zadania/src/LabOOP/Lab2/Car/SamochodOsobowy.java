...
public class SamochodOsobowy extends Samochod
{
    ...
    public void setPojemnoscSilnika(double pojemnoscSilnika) { this.pojemnoscSilnika = pojemnoscSilnika; }
    public double getIloscOsob() { return iloscOsob; }
