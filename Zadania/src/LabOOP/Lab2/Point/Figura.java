...
public class Figura
{
	...
	public Figura() {}
	public Figura(String kolor) { this.kolor = kolor; }
	public Figura(Punkt punkt) { this.punkt = punkt; }
	...
	public Punkt getPunkt() { return punkt; }
	public String getKolor(){ return kolor; }
	public void setPunkt(Punkt punkt){ this.punkt = punkt; }
	public void setKolor(String kolor){ this.kolor = kolor; }

	public void przesun(double x, double y) { punkt.przesun(x, y); }
	public void opis()
	{
