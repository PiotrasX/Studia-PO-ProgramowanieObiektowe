...
public class Ksiazka
{
    ...
    public Ksiegarnia getAdres() { return adres; }
    public void setAdres(Ksiegarnia adres) { this.adres = adres; }
    ...
    public void setLiczbaStron(int liczbaStron) { this.liczbaStron = liczbaStron; }
