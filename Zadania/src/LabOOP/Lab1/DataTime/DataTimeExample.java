...
public class DataTimeExample
{
    ...
    public static void calendarExample()
    {
        ...
        System.out.println("Następna dawka szczepionki planowana na: " + df.format(nextVaccine));
        System.out.println();
    }
    ...
    public static void localDTExample()
    {
        ...
        System.out.println(dtf.format(ldt.minusYears(1)) + " - minus 1 rok"); // 27-05-2020 14:23:20
        System.out.println(dtf.format(ldt.plusDays(1)) + " - plus 1 dzień"); // 28-05-2020 14:23:20
    }
}
