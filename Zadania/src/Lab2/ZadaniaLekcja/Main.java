...
public class Main
{
    public static void main(String[] args)
    {
        ...
        // lista dostępnych metod klasy Random wyświetli się po wpisaniu nazwy obiektu i kropki w tym przypadku: rand.
        // W przypadku zapisu rand.nextInt(n); wylosowana zostanie liczba z zakresu od 0 do n-1,
        // czyli chcąc wylosować liczbę z zakresu od 1 do 10 (domkniętego) należy zapisać: rand.nextInt(10) + 1;

        // Losowanie liczby z zakresu [0,10] do zmiennej a.
        int a = rand.nextInt(11); // Deklaracja i definicja zmiennej
        System.out.println("\nWylosowana liczba z zakresu [0,10]: " + a);
