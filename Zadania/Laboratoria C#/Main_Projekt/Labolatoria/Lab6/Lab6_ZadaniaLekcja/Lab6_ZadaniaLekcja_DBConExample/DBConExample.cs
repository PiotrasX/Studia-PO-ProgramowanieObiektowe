...
namespace Lab6_ZadaniaLekcja_DBConExample
{
    internal class DBConExample()
    {
        public static void Main(string[] args)
        {
            //string connectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=SampleDB;Integrated Security=True";
            string connectionString = "Data Source=LAPTOP-PIOTRASX;Initial Catalog=DBConExample;Integrated Security=True";
